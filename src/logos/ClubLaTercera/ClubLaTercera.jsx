...
export const ClubLaTercera = props => {
  const {
    dark = '#000000',
    light = '#ffffff',
    red = '#A01622',
    ...
    <svg x="0px" y="0px" viewBox="0 0 1431.7 507.7" {...props}>
      <g>
        <g fill={colorschema.letters}>
          <polyline
            points="704.7,390.5 664.9,390.5 664.9,371.8 765.6,371.8 765.6,390.5 725.8,390.5 725.8,505.9 704.7,505.9
			704.7,390.5 		"
          />
          <path
            d="M971.7,505.9h-25.1l-22.9-32.6c-3,0.4-6.3,0.6-9.6,0.6h-13.2v32h-21.1V371.8h34.3c36.9,0,57.2,20.3,57.2,51.3
          ...
          />
          <path
            d="M980,438.8c0-39.6,30.2-68.8,68.4-68.8c24.9,0,42,9.6,53.7,26l-16.2,11.4c-8.9-12-20.3-18.4-38.1-18.4
          ...
          />
          <path
            d="M1308.5,505.9h-25.1l-22.9-32.6c-3,0.4-6.3,0.6-9.6,0.6h-13.2v32h-21.2V371.8h34.3
          ...
          />
          <path
            d="M1334.1,505.9h-21.3l58.8-136.9h1.2l59,136.9h-22.3l-7.7-18.7h-59.9L1334.1,505.9 M1372,415.4l-22.3,53h44.2
			L1372,415.4z"
          />
          <polyline
            points="1204,487.2 1137.7,487.2 1137.7,464.5 1194.7,464.5 1194.7,446.1 1137.7,446.1 1137.7,390.5
			1204,390.5 1204,371.8 1116.6,371.8 1116.6,505.9 1204,505.9 1204,487.2 		"
          />
          <polyline
            points="799.9,464.5 856.9,464.5 856.9,446.1 799.9,446.1 799.9,390.5 866.9,390.5 866.9,371.8 778.9,371.8
			778.9,505.9 867,505.9 867,487.2 799.9,487.2 799.9,464.5 		"
          />
          <polyline points="480.3,371.9 501.3,371.9 501.3,487.2 561.9,487.2 561.9,505.9 480.3,505.9 480.3,371.9 		" />
          <path
            d="M568.1,505.9h-21.3l58.8-136.8h1.3l58.9,136.8h-22.3l-7.7-18.7h-60L568.1,505.9 M606,415.4l-22.3,53h44.1
			L606,415.4z"
          />
        </g>
        <g>
          <path
            ...
            d="M408.4,130C376.5,52.6,299.5-0.6,210.5,0C93.5,0.7-0.7,96.2,0,213.2c0.7,117,96.2,211.3,213.2,210.5
          ...
          <path
            ...
            d="M139.5,241v14.4c-9.6,5.2-20.7,7.9-33.3,7.9c-10.2,0-18.9-2.1-26-6.2c-7.1-4.1-12.7-9.8-16.9-17
          ...
          <path
            fill={colorschema.isotypeletter}
            d="M279.7,170.7h13.1v51.9c0,7-0.5,12.3-1.5,15.9c-1,3.6-2.3,6.6-3.8,8.9c-1.5,2.4-3.3,4.5-5.5,6.4
          ...
          <path
            fill={colorschema.isotypeletter}
            d="M339.2,262.2h-31v-91.5h24c7.6,0,13.5,1,17.7,3c4.2,2,7.5,4.8,9.7,8.4c2.2,3.6,3.3,7.7,3.3,12.3
