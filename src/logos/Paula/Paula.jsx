  ...
  return (
    <svg x="0px" y="0px" viewBox="0 0 172.3 57.6" {...props}>
      <g fill={colorschema.letters}>
        ...
        />
        <path
          d="M64.6,40.4c0,0.8,0.5,1.4,1.4,1.4c0.7,0,1.6-0.4,2.4-0.9l0.2,1.3c-2.5,2-5.7,3.7-9.2,3.7
        ...
        />
        <path
          d="M93,19.9c0-2.3-0.4-2.5-4.9-2.8v-1.3l14.1-2.1h1.1v26.6c0,2.3,0.4,2.5,3.7,2.8v1.3l-12.6,1.5
        ...
        />
        <path
          d="M122.6,41.5c0,1.8,0.4,2,3.7,2.4v1.3h-17.6v-1.3c3.3-0.3,3.7-0.6,3.7-2.4V5.6
		c0-2.3-0.4-2.5-3.7-2.8V1.5L121.7,0h0.9V41.5z"
        />
        <path
          d="M155,40.4c0,0.8,0.5,1.4,1.4,1.4c0.7,0,1.6-0.4,2.4-0.9l0.2,1.3c-2.5,2-5.7,3.7-9.2,3.7
        ...
        />
        <path
          d="M167.6,36.2c2.5,0,4.6,2.1,4.6,4.7c0,2.5-2.1,4.6-4.6,4.6c-2.5,0-4.6-2.1-4.6-4.6
