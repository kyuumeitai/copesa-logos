...
const MtNews = props => {
  ...
  return (
	...
	L208.6,77.2z"
        />
        <polygon
          points="149.1,19 158.1,0.4 84.7,0.4 62.2,0.4 43,44 22.5,0.4 0.9,0.4 0.9,77.2 22.6,77.2 22.5,38.5
	37.6,77.2 48.1,77.2 63.1,38.5 63.1,77.2 84.7,77.2 84.7,19 105.5,19 105.5,18.9 105.5,18.9 105.5,77.2 129.1,77.2 129.1,19 "
        />
        <g>
          <path
            d="M421,76.7c3.2-1.1,6-2.5,8.2-4.3s4-4,5.2-6.4c1.2-2.5,1.8-5.1,1.8-7.9v-0.2c0-2.6-0.4-4.9-1.3-7
        ...
        <polygon
          points="302.8,77.8 304.9,77.8 327.9,5.3 351.1,77.8 353.1,77.8 378.4,1.1 376,1.1 352.1,74.1 328.9,0.9
	327.1,0.9 303.9,73.9 280,1.1 277.5,1.1 "
        />
        <polygon
          points="221.7,77.2 275.4,77.2 275.4,75 224.1,75 224.1,40 270.2,40 270.2,37.8 224.1,37.8 224.1,3.3
