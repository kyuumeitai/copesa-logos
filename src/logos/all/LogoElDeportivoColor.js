...
const SvgLogoElDeportivoColor = props => (
  <svg
    id="Logo_ElDeportivo_color_svg__Layer_1"
    x={0}
    y={0}
  ...
  >
    <style>
      {
        ".Logo_ElDeportivo_color_svg__st0{fill:#b2292e}.Logo_ElDeportivo_color_svg__st2{fill:#1c1c1b}"
      }
    </style>
    <path
      className="Logo_ElDeportivo_color_svg__st0"
    ...
    />
    <path
      className="Logo_ElDeportivo_color_svg__st2"
...
export default SvgLogoElDeportivoColor;
