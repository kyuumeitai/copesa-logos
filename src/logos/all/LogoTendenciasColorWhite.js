...
const SvgLogoTendenciasColorWhite = props => (
  <svg
    id="Logo_Tendencias_color_white_svg__Layer_1"
    x={0}
    y={0}
  ...
  >
    <style>
      {
        ".Logo_Tendencias_color_white_svg__st0{fill:#b2292e}.Logo_Tendencias_color_white_svg__st1{fill:#fff}"
      }
    </style>
    <path
      className="Logo_Tendencias_color_white_svg__st0"
      d="M0 38.8h58.7v56.3H0z"
    />
    <path
      className="Logo_Tendencias_color_white_svg__st1"
...
export default SvgLogoTendenciasColorWhite;
