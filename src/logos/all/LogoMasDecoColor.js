...
const SvgLogoMasDecoColor = props => (
  <svg
    id="Logo_MasDeco_color_svg__Layer_1"
    x={0}
    y={0}
  ...
  >
    <style>
      {
        ".Logo_MasDeco_color_svg__st0{fill:#1c1c1b}.Logo_MasDeco_color_svg__st1{fill:#b2292e}"
      }
    </style>
    <path
      className="Logo_MasDeco_color_svg__st0"
...
export default SvgLogoMasDecoColor;
